...
int main()
{
    ...
    freopen("NFA_to_DFA.txt", "r", stdin);
    ...
    cout << endl
         << "This is the list of all subset of our given states: " << endl;
    for (auto n : newstate)
    {
        for (auto s : n)
        {
    ...
    cout << "This is the new subset transition table: " << endl
         << endl;
    ;
        ...
        for (int j = 0; j < newTable[b].size(); j++)
        {
            ...
            for (int k = 0; k < newstate.size(); k++)
            {
                if (newTable[b][j] == newstate[k])
                {
                    ...
                    if (k != b && k > b)
                        track.push(mp[newTable[b][j]]);
                    break;
                }
            }
        }
        if (!res.empty())
            dfaTable.push_back(res);
    ...
    cout << "All the states of DFA: " << endl
         << endl;
    ...
    cout << endl
         << endl;
    cout << "Start states of DFA: " << start << endl
         << endl;
    cout << "Final states of DFA: " << end << endl
         << endl;

    // This part of the code print the Transition table of our DFA

    cout << "This is our desired DFA table: " << endl
         << endl;
    for (auto it : table)
    {
        cout << it.first << "  -> ";
